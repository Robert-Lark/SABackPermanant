...
function makeCreateContext({
  ...
  const createContext = ({
    ...
    var _keystone$adapters$Kn, _keystone$adapters$Mo, _keystone$adapters$Pr;
    ...
    const contextToReturn = _objectSpread2(_objectSpread2(_objectSpread2({
      ...
      knex: (_keystone$adapters$Kn = keystone.adapters.KnexAdapter) === null || _keystone$adapters$Kn === void 0 ? void 0 : _keystone$adapters$Kn.knex,
      mongoose: (_keystone$adapters$Mo = keystone.adapters.MongooseAdapter) === null || _keystone$adapters$Mo === void 0 ? void 0 : _keystone$adapters$Mo.mongoose,
      prisma: (_keystone$adapters$Pr = keystone.adapters.PrismaAdapter) === null || _keystone$adapters$Pr === void 0 ? void 0 : _keystone$adapters$Pr.prisma,
      graphql: {
        createContext,
        raw: rawGraphQL,
        run: runGraphQL,
...
function createKeystone(config, createContextFactory) {
  ...
  if (db.adapter === 'knex') {
    ...
    adapter = new PrismaAdapter(_objectSpread2({}, db));
  ...
  const keystone = new Keystone({
    ...
    onConnect: () => {
      ...
      return (_config$db$onConnect = (_config$db = config.db).onConnect) === null || _config$db$onConnect === void 0 ? void 0 : _config$db$onConnect.call(_config$db, createContextFactory()({
...
export { createSystem as c, initConfig as i };
