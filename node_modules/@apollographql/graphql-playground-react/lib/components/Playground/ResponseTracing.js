...
function (_super) {
  ...
  ResponseTracing.prototype.render = function () {
    ...
    })) : tracingSupported ? /*#__PURE__*/React.createElement(ReRun, null, this.props.queryRunning ? 'Running query ...' : 'Please re-run the query to show tracing results.') : /*#__PURE__*/React.createElement(NotSupported, null, "This GraphQL server doesn\u2019t support tracing. See the", ' ', /*#__PURE__*/React.createElement("a", {
      target: "_blank",
